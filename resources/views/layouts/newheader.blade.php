...
<head>
	...
	<title>Glorious Empire Hotels</title>
	  <!--favicon-->
...
<!-- Start wrapper-->
 <div id="wrapper">
  ...
  <!--Start sidebar-wrapper--><?php
  	if(Auth::user()->is_admin == "Admin") { ?>
  	...
  	}elseif(Auth::user()->is_admin == "Learner"){ ?>
     	...
     	<div class="brand-logo">
		    <a href="{{route('admin.dashboard')}}">
		       ...
		       <h5 class="logo-text">Glorious Emp Hotels</h5>
		   	</a>
   		</div>
		<div class="user-details">
		    <div class="media align-items-center user-pointer collapsed" data-toggle="collapse" data-target="#user-dropdown">
		      	<div class="avatar"><?php $partner_email = Auth::user()->email; 
		      		...
		      		if(($partner_email = Auth::user()->email) AND (Auth::user()->is_admin == "Partner")){ ?>
			      		...
			      		<img class="mr-3 side-user-img" src="{{asset('styling/assets/images/logo.jpg')}}" alt="user avatar"><?php
			      	} ?>
		      	</div>
	   	...
	   	<ul class="sidebar-menu do-nicescrol">
	        ...
	        @if($user_type == "Admin")
			    ...
			    <li>
			        <a href="{{route('user.activity')}}" class="waves-effect">
			          	<i class="zmdi zmdi-view-dashboard"></i> <span>Users Activities</span>
			          	<small class="badge float-right badge-light"><i class="zmdi zmdi-long-arrow-right"></i></small>
			        </a>
			    </li>
			    <li>
			        <a href="{{route('type.create')}}" class="waves-effect">
			          	<i class="zmdi zmdi-view-dashboard"></i> <span>Room Category</span>
			          	<small class="badge float-right badge-light"><i class="zmdi zmdi-long-arrow-right"></i></small>
			        </a>
			    </li>

			    <li>
			        <a href="{{route('room.create')}}" class="waves-effect">
			          	<i class="zmdi zmdi-view-dashboard"></i> <span>Room Manager</span>
			          	<small class="badge float-right badge-light"><i class="zmdi zmdi-long-arrow-right"></i></small>
			        </a>
			    </li>
			    <li>
			        <a href="{{route('facility.create')}}" class="waves-effect">
			          	<i class="zmdi zmdi-view-dashboard"></i> <span>Hotel Facility</span>
			          	<small class="badge float-right badge-light"><i class="zmdi zmdi-long-arrow-right"></i></small>
			        </a>
			    </li>

			    <li>
			        <a href="{{route('services.create')}}" class="waves-effect">
			          	<i class="zmdi zmdi-view-dashboard"></i> <span>Hotel Services</span>
			          	<small class="badge float-right badge-light"><i class="zmdi zmdi-long-arrow-right"></i></small>
			        </a>
			    </li>
			    ...
			    <li>
			        <a href="" class="waves-effect">
			          	<i class="zmdi zmdi-view-dashboard"></i> <span>Room Facility</span>
			          	<small class="badge float-right badge-light"><i class="zmdi zmdi-long-arrow-right"></i></small>
			        </a>
			    </li>
			     ...
			     <li>
			        <a href="" class="waves-effect">
			          	<i class="zmdi zmdi-view-dashboard"></i> <span>Room Status</span>
			          	<small class="badge float-right badge-light"><i class="zmdi zmdi-long-arrow-right"></i></small>
			        </a>
			    </li>
			    ...
			    <li>
			        <a href="" class="waves-effect">
			          	<i class="zmdi zmdi-view-dashboard"></i> <span> Check Out</span>
			          	<small class="badge float-right badge-light"><i class="zmdi zmdi-long-arrow-right"></i></small>
			        </a>
			    </li>
			    ...
			    <li>
			        <a href="" class="waves-effect">
			          	<i class="zmdi zmdi-view-dashboard"></i> <span>Check In</span>
			          	<small class="badge float-right badge-light"><i class="zmdi zmdi-long-arrow-right"></i></small>
			        </a>
			    </li>
			    ...
			    <li>
			        <a href="" class="waves-effect">
			          	<i class="zmdi zmdi-view-dashboard"></i> <span>Guest</span>
			          	<small class="badge float-right badge-light"><i class="zmdi zmdi-long-arrow-right"></i></small>
			        </a>
			    </li>
			    ...
			    <li>
			        <a href="" class="waves-effect">
			          	<i class="zmdi zmdi-view-dashboard"></i> <span>Reservation</span>
			          	<small class="badge float-right badge-light"><i class="zmdi zmdi-long-arrow-right"></i></small>
			        </a>
			    </li>
			    <li>
				<a href="" class="waves-effect">
			          	<i class="zmdi zmdi-view-dashboard"></i> <span>Payments</span>
			          	<small class="badge float-right badge-light"><i class="zmdi zmdi-long-arrow-right"></i></small>
			        </a>
			    </li>
...
<header class="topbar-nav">
 	<nav class="navbar navbar-expand fixed-top">
  		<ul class="navbar-nav mr-auto align-items-center">
		    ...
		    <h4 align="center"><p >GLORIOUS EMPIRE HOTELS</p></h4>
  		</ul>
  		...
  		<ul class="navbar-nav align-items-center right-nav-link">
			...
			<li class="nav-item">
			    ...
			    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="">
			        <span class="user-profile"><img src="{{asset('styling/assets/images/logo.jpg')}}" class="img-circle" alt="user avatar"></span>
			    </a>
