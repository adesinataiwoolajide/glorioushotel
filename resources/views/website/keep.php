			...
			<div id="tools">
				<div class="row">
					...
					<div class="col-md-6 col-sm-4 d-none d-sm-block text-right">
						<a href="#" class="bt_filters"><i class="icon-th"></i></a> <a href="{{route('roomcategories')}}" class="bt_filters"><i class=" icon-list"></i></a>
					</div>
				</div>
			</div>
			<!--End tools -->
				...
				<div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.1s">
					<div class="row">
						<div class="col-lg-4 col-md-4">
							...
							<div class="img_list">
								<a href="{{route('roomdetails', $typo->id)}}">
									<img src="{{asset('room_types/'.$typo->type_banner)}}" style="widows: 500px;" alt="Image">
						...
						<div class="col-lg-6 col-md-6">
							<div class="tour_list_desc">
								<div class="score">Superb<span>5*</span>
								</div>
								...
								<h3><strong>{{$typo->type_name}}</strong> </h3>
								<p><b>{{$typo->description}}</b></p>
								<ul class="add_info">
									<li>
						...
						<div class="col-lg-2 col-md-2">
							<div class="price_list">
								<div><sup>&#8358;<b><?php echo number_format($typo->amount) ?></sup></b>
								<span class="normal_price_list"><?php
									$money =  (20/100)*$typo->amount; ?>
									&#8358;<b><?php echo number_format($money + $typo->amount);

								?></b>
								</span>
								<small>*From/Per night</small>
								<p><a href="{{route('roomdetails', $typo->id)}}" class="btn_1">View Details</a></p>
								</div>
							</div>
						</div>
					</div>
