	            		...
	            		<div class="card-body">
	            			<form action="{{route('user.save')}}" method="POST" enctype="multipart/form-data">
		            			...
		            			<div class="form-group row ">
		            				<div class="col-sm-3">
					                    <input type="text" class="form-control" name="name" required placeholder="Enter Name" value="{{ $used->name}}">
					                ...
					                <div class="col-sm-3">
					                    <input type="email" class="form-control"  name="email" placeholder="Enter E-Mail" min="4" required value="{{ $used->email}}">
					                    <span style="color: red">** This Field is Required **</span>
					                     @if ($errors->has('email'))
                                            <div class="alert alert-danger alert-dismissible" role="alert">
										        <button type="button" class="close" data-dismiss="alert">&times;</button>
					                ...
					                <div class="col-sm-3">
					                	<?php $list = array("Admin", "Secretary", "Manager", "Bar Man", "Cleaner", "Driver", "Store Keeper", "Messenger")    ?>
					                   	<select class="form-control" name="is_admin" required>
					                   		<option value="{{ $used->is_admin}}">{{$used->is_admin}}</option>
					                   		<option value=""></option>
